...
| `ClusterMonitoringOperatorDeprecatedConfig` | info | 1h | The configuration field $labels.field in $labels.config map was deprecated in $labels.deprecation_version and has no effect.
