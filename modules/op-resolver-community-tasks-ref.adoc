...
|`application-name` |The name of the application to sync.|
|`revision` |The revision to sync to. | `HEAD`
|`flags` |  | `--`
...
|`overwrite_values` |The values to overwrite, comma separated. For example: `autoscaling.enabled=true,replicas=1`|`""`
...
|`release_namespace` |The Helm release namespace. |`""`
|`overwrite_values` |The values to overwrite, comma separated. For example: `autoscaling.enabled=true,replicas=1`|`""`
|`values_file` |The values file to be used. |`values.yaml`
|`helm_image` |The Helm image to be used. |`docker.io/lachlanevenson/k8s-helm@sha256:5c792f29950b388de24e7448d378881f68b3df73a7b30769a6aa861061fd08ae`
