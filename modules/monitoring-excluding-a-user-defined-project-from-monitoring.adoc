...
[role="_abstract"]
Individual user-defined projects can be excluded from user workload monitoring. To do so, you can add the `openshift.io/user-monitoring` label to the project's namespace with a value of `false`.
