...
For more information about monitoring updates, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/release_notes/ocp-4-21-release-notes#rn-ocp-release-notes-async-errata-updates_release-notes[Asynchronous errata updates].