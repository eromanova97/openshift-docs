...
* For {ocp}, you have access to the cluster as an administrator for the project for which you want to view metrics targets.
* For {product-rosa-hcp} and {product-dedicated}, you have access to the cluster as a user with the `dedicated-admin` role.
...
* **Source** filters:
** **Platform**. Platform-level targets relate only to default {ocp} projects. These projects provide core {ocp} functionality.
