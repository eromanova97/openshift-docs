...
* xref:../../observability/monitoring/managing-alerts.adoc#configuring-alert-routing-user-defined-alerts_managing-alerts[Configure notifications for user-defined alerts].
