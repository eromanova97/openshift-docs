...
In {product-title} {product-version}, firing alerts can be viewed in the Alerting UI. You can configure Alertmanager to send notifications about default platform alerts by configuring alert receivers.
