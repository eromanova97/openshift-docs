...
With this update, you can configure the intervals between consecutive scrapes and between rule evaluations for user workload monitoring Prometheus.
...
With this update, Alertmanager uses the proxy environment variables, therefore, you can enable proxying for all alert receivers.
